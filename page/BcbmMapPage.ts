...
module gamebenchibaoma.page {
    ...
    export class BcbmMapPage extends game.gui.base.Page {
        private _viewUI: ui.game_ui.benchibaoma.BenChiBaoMaUI;
        ...
        private onUpdateSeatedList(qifu_index?: number): void {
            ...
            for (let i = 0; i < this._seatList.length; i++) {
                ...
                if (unit) {
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).txt_name.text = getMainPlayerName(unit.GetName());
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).txt_name.fontSize = 15;
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).txt_money.text = EnumToString.getPointBackNum(unit.GetMoney(), 2).toString();
                    let unitHeadImg = unit.GetHeadImg();
                    if (unitHeadImg) {
                        (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).img_icon.skin = PathGameTongyong.ui_tongyong_touxiang + "head_" + unitHeadImg + ".png";
                    }
                        ...
                        if (qifu_index && unitIndex == qifu_index) {
                            Laya.timer.once(2500, this, () => {
                                ...
                                if (unit.GetQiFuType()) {
                                    ...
                                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).img_icon.skin = PathGameTongyong.ui_tongyong_touxiang + "head_" + qifuImgUrl + ".png";
                                }
                            })
                        } else {
                            this._seatList[i].img_qifu.visible = true;
                    ...
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).txt_name.text = "";
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).txt_name.fontSize = 20;
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).txt_money.text = "点击入座";
                    (this._seatList[i] as ui.game_ui.benchibaoma.component.TouXiangWzUI).img_icon.skin = PathGameTongyong.ui_tongyong_general + "tu_weizi.png";
                    this._seatList[i].img_qifu.visible = false;
    ...
    class MapRecordRender extends ui.game_ui.benchibaoma.component.RecordItemUI {
        private _game: Game;
        private _data: any;
        constructor() {
            super();
