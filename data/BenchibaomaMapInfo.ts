...
module gamebenchibaoma.data {
	...
	export class BenchibaomaMapInfo extends gamecomponent.object.MapInfoT<gamecomponent.object.MapInfoLogObject> {
		//地图状态变更
		static EVENT_STATUS_CHECK: string = "BenchibaomaMapInfo.EVENT_STATUS_CHECK";
		//战斗体更新
		static EVENT_BATTLE_CHECK: string = "BenchibaomaMapInfo.EVENT_BATTLE_CHECK";
		//继续游戏状态
		static EVENT_STATUS_CONTINUE: string = "BenchibaomaMapInfo.EVENT_STATUS_CONTINUE";
		//牌局号
		static EVENT_GAME_NO: string = "BenchibaomaMapInfo.EVENT_GAME_NO";
		//倒计时时间戳更新
		static EVENT_COUNT_DOWN: string = "BenchibaomaMapInfo.EVENT_COUNT_DOWN";
		//游戏记录更新
		static EVENT_GAME_RECORD: string = "BenchibaomaMapInfo.EVENT_GAME_RECORD";
		//入座列表更新
		static EVENT_SEATED_LIST: string = "BenchibaomaMapInfo.EVENT_SEATED_LIST";
